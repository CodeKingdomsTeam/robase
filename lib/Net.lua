...
function Net.AddEvent( name ) --: string => void
    if(RunService:IsServer()) then
        ...
        Logger.Warn("Tried to add event ", name ,". Net.AddEvent can only be called from a non-local script. Also make sure you are testing with a local server and clients!")
   end
end
...
function Net.BroadcastEvent( name, ... ) --: string, ...Serializable => void
    ...
    if(RunService:IsServer()) then
        ...
        Logger.Warn("Net.Broadcast can only be called from a non-local script. Also make sure you are testing with a local server and clients!")
    end 
end
